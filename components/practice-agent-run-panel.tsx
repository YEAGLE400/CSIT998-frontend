          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <Badge variant="secondary">Frontend MVP Agent Run</Badge>
              </div>
              <CardTitle className="text-2xl">Generating a personalized practice session</CardTitle>
              <CardDescription>
                The page is simulating `plan`, `generate`, and `review` using KC signals from the current mock graph.
              </CardDescription>
            </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <Card className="border-border/50 bg-card">
          <CardHeader>
            ...
            <CardDescription>Live artifacts generated by each mock agent stage</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            {run.plan && (
